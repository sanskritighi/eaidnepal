...
const Sidebar = ({ open, toggleSidebar }) => {
    const sidemenus = [
        ...
        {
            name: "Manage", icon: BsDatabaseGear, has_submenus: true,
            submenus: [
                ...
                { name: "Add Files", link: "/addfiles", icon: AiOutlineFileAdd , has_submenus: false },
                { name: "Add Syllabus", link: "/addsyllabus", icon: MdOutlineFormatListNumbered  },
                { name: "Add Blogs", link: "/addblogsdata", icon: FaBlog  },
            ]
        },
