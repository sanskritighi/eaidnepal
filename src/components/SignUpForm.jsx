...
const SignUpForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    register(formData.name, formData.email, formData.password, formData.cpassword,formData.contact).then(
      resp => {
          handleSuccess()
      }
    ).catch(
      ...
      <form onSubmit={handleSubmit} className="w-full h-full flex flex-col justify-center items-center p-4 space-y-4">
        ...
        <div className="space-y-4 flex justify-center items-center flex-col">
          ...
          <div className="space-y-1 flex flex-col text-left">
            ...
            <input name='contact' type='number' minLength={10} maxLength={10} placeholder="9845XXXXXX" value={formData.contact}
